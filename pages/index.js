...
#box1 {
    border-color: rgba(238, 198, 135, 0.40);
...
li {
    ...
    <ul>
      ...
      <li><a href="http://jtablet.cellosoft.com/">JTablet Plugin</a> &mdash;
        Java library for accessing graphics tablet input <span className="time">(2003 to 2012)</span></li>
      <li><a href="http://alt.cellosoft.com/">Alt Framework</a> &mdash;
        server-side javascript web framework <span className="time">(2006 to 2009)</span></li>
    </ul>
    <h2>Archived projects</h2>
    <p>(courtesy of <a href="https://web.archive.org/">archive.org</a>)</p>
    <ul>
      <li><a href="https://web.archive.org/web/20101029202045/http://www.cs.unm.edu/~cello/processing/"
             className="unavailable">I LIKE PROCESSING</a> &mdash;
        interactive art java applets made with processing <span className="time">(2004 to 2006)</span></li>
      <li><a href="https://web.archive.org/web/20130625054816/http://marcello.cellosoft.com/projects/squeal/"
             className="unavailable">SQueaL with Delight</a> &mdash;
        xml-based sql schema system prototype <span className="time">(2006)</span></li>
      <li><a href="https://web.archive.org/web/20090329155558/http://www.cs.unm.edu/~cello/livingescher/"
             className="unavailable">living escher</a> &mdash;
        art exhibit in processing <span className="time">(2004)</span></li>
      ...
      <li><a href="https://web.archive.org/web/20130509082207/http://www.cs.unm.edu/~cello/jsgen/"
        ...
        utility for bridging C++ classes to JS in Spidermonkey <span className="time">(2004)</span></li>
      <li><a href="https://web.archive.org/web/20130625053550/http://marcello.cellosoft.com/art/">art/</a> &mdash;
        old art archive <span className="time">(2001 to 2003)</span></li>
    </ul>
